...
const Register = () => {
    ...
    const phoneRegExp = /^(\+[1-9]\d{0,3}[ -]?)?\d{3,}$/
        ...
        <div className='w-full  flex flex-col md:flex-row gap-4 items-center justify-center  mx-auto' >
            ...
            <div className='w-full md:w-1/2 items-center md:items-start justify-center md:justify-start px-3 mx-auto '>
                <div className='flex items-center justify-center flex-col sm:px-3  drop-shadow-sm border-2 lg:w-2/3 rounded-lg gap-4 py-4 mx-auto'>
                    <h1 className='font-semibold text-5xl text-neutralDGray '>Register </h1>
                    <form className="flex items-center justify-center flex-col gap-4  px-3 py-5 w-full" onSubmit={formik.handleSubmit}>


                        <div className='w-72'>
                            <div className="mb-2 block">
                                <Label htmlFor="name1" value="Name" className='text-neutralDGray' />
                            </div>
                            <input id="name1" type="text" placeholder="Md. Masum Ahmed" required className='w-full rounded-lg border-slate-500 focus:border-branchPrimary' name='name' value={formik.values.name} onChange={formik.handleChange} />
                        ...
                        <div className='w-72'>
                            <div className="mb-2 block">
                                <Label htmlFor="email1" value="Email" className='text-neutralDGray' />
                            </div>
                        ...
                        <div className='w-72'>
                            <div className="mb-2 block">
                                <Label htmlFor="phone1" value="Phone" className='text-neutralDGray' />
                            </div>
                            <input id="phone1" type="text" placeholder="+8801*********" required className='w-full rounded-lg border-slate-500 focus:border-branchPrimary' name='phone' value={formik.values.phone} onChange={formik.handleChange} />
                        ...
                        <div className='w-72 relative'>
                            <div className="mb-2 block">
                                <Label htmlFor="cpassword1" value="Confirm Password" className='w-full text-neutralDGray' />
                            </div>
                            <input id="cpassword1" type={isConfirmPasswordVisible ? "text" : "password"} placeholder="********" required className='w-full rounded-lg border-slate-500 focus:border-branchPrimary' name='confirmPassword' value={formik.values.confirmPassword} onChange={formik.handleChange} />
                    ...
                    <div className='pb-4'>
                        <p className='text-neutralDGray'>Already Have An Account? <Link to={'/login'} className='text-branchPrimary font-semibold cursor-pointer'>Login</Link></p>
                    </div>
                </div>
            </div>
        </div>
